...
_Caellitta Home_`,
    ...
    {
      phase: 'Pre-arrival', timing: '-1 day', name: 'Arrival instructions',
      text: (v) => `Hi ${v.name || '[Name]'}!

Tomorrow we're expecting you at Caellitta Home 🏡

Here's everything you need:

🔑 *House access:*
The lockbox code is *[CODE]*. You'll find it to the left of the main door.

🚗 *Parking:*
You can leave your car on [__] street, free parking.

📍 *Exact address:*
[Address], [City]

If you arrive outside the scheduled time or need anything, message us right away — we're quick to respond!
...
_Caellitta Home_`,
    ...
    {
      phase: 'During', timing: 'Mid-stay', name: 'Mid-stay check',
      text: (v) => `Hi ${v.name || '[Name]'}, how are you finding Caellitta Home?

We're halfway through your stay and wanted to make sure everything is perfect ✨

Is there anything we can do to make your experience even better?

Remember you still have coupons to use — don't waste them! 🎁

_Caellitta Home_`,
    },
    {
      phase: 'Departure', timing: 'Check-out', name: 'Farewell + review',
      text: (v) => `Hi ${v.name || '[Name]'},

It's been a pleasure hosting you! We hope your stay at Caellitta Home lived up to your expectations 🌊
...
If you have a moment, a review on [platform] would help us enormously — every piece of feedback matters to us 🙏
...
export default function WhatsApp() {
  ...
  useEffect(() => {
    sb.from('bookings').select('*').neq('status', 'cancelled').order('check_in', { ascending: false })
