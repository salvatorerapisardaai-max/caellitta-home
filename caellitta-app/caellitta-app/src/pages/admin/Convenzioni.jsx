...
const EMPTY_PARTNER = { partner: '', title: '', discount: '', description: '', active: true }
...
export default function Convenzioni() {
  ...
  function openEdit(t) {
    setForm({ partner: t.partner||'', title: t.title||'', discount: t.discount||'', description: t.description||'', active: t.active ?? true })
  ...
  async function savePartner() {
    ...
    const payload = { partner: form.partner, title: form.title, discount: form.discount, description: form.description || null, active: form.active }
    try {
      if (editing) {
